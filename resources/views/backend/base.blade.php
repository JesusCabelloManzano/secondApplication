...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('backend.main') }}" class="nav-link">Home</a>
      </li>
    </ul>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Buena pagina mi panita</p>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Que guapa la pag, vaya tula</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 16 Hours Ago</p>
              </div>
            </div>
            <!-- Message End -->
          </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('backend.main') }}" class="brand-link">
      <span class="brand-text font-weight-light">Second Application</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ url('assets/backend/dist/img/Jesus.jpg') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Jesus Cabello</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route ('backend.ticket.index') }}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Show Tickets</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('backend.ticket.create') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Tickets</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('backend.main') }}">Home</a></li>
